...
| SP2 | Optional Canvas API publish | In progress | `src/canvas-api.ts`, `src/tools/list-courses.ts`, `src/tools/publish.ts`, `src/tools/gotchas.ts`, `src/index.ts`, `src/wizard.ts` | `docs/superpowers/specs/2026-05-04-sp2-publish-canvas-design.md`, `docs/superpowers/plans/2026-05-04-sp2-publish-canvas-design.md` | Tasks 1-4 complete: shared types/config, Canvas API client, gotcha messages, and list_canvas_courses logic. Next: publish_to_canvas logic. |
