...
| SP2 | Optional Canvas API publish | In progress | `src/canvas-api.ts`, `src/tools/list-courses.ts`, `src/tools/publish.ts`, `src/tools/gotchas.ts`, `src/index.ts`, `src/wizard.ts` | `docs/superpowers/specs/2026-05-04-sp2-publish-canvas-design.md`, `docs/superpowers/plans/2026-05-04-sp2-publish-canvas-design.md` | Tasks 1-5 complete: shared types/config, Canvas API client, gotcha messages, list_canvas_courses logic, and publish_to_canvas logic. Next: Task 6 MCP tool registration. |
