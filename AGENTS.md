# Canvas Design Studio — Codex Instructions
...
3. If the change affects `AGENTS.md` (e.g., a new allowed/disallowed property), update it here too
...
That's it. Everything else is derived from the ingest files and this AGENTS.md.
